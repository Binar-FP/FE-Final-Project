...
import './forgot.css'
import { forgotActions } from '../../config/redux/actions/authActions';



const ResetPasswordSend = (props) => {
    const { register, handleSubmit, formState: { errors, isDirty, isValid}} = useForm();
    const dispatch = useDispatch();
    
    const onSubmit = (data) => {
        // HIT API FORGOT AND SEND EMAIl
        dispatch(forgotActions(data));
    }

  return (
    <>
     <>
      <section className="position-relative py-4 py-xl-5 content-password">
